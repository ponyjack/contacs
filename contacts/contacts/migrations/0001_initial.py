# Generated by Django 2.1.1 on 2018-09-16 12:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True, verbose_name='date added')),
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'contacts'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'contacts'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('location', models.ForeignKey(limit_choices_to={'is_street_address': False}, on_delete=django.db.models.deletion.CASCADE, to='contacts.Location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'contacts'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('location', models.ForeignKey(limit_choices_to={'is_phone': False}, on_delete=django.db.models.deletion.CASCADE, to='contacts.Location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modified', models.DateTimeField(auto_now=True, verbose_name='date modified')),
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'contacts'}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('location', models.ForeignKey(limit_choices_to={'is_phone': False, 'is_street_address': False}, on_delete=django.db.models.deletion.CASCADE, to='contacts.Location')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='location',
            field=models.ForeignKey(limit_choices_to={'is_phone': False, 'is_street_address': False}, on_delete=django.db.models.deletion.CASCADE, to='contacts.Location'),
        ),
        migrations.AddField(
            model_name='group',
            name='people',
