...
class Person(models.Model):
    ...
    company = models.ForeignKey(Company, blank=True, null=True,on_delete=models.SET_NULL, related_name='persons')
...
class EmailAddress(models.Model):
    ...
    location = models.ForeignKey(Location, limit_choices_to={
        'is_street_address': False, 'is_phone': False},on_delete=models.CASCADE)
...
class StreetAddress(models.Model):
    ...
    location = models.ForeignKey(Location, limit_choices_to={
        'is_phone': False},on_delete=models.CASCADE)
